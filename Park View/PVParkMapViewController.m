...
- (void)viewDidLoad
{
    ...
    CLLocationDegrees latDelta = self.park.overlayTopLeftCoordinate.latitude - self.park.overlayBottomLeftCoordinate.latitude;
...
-(void)addBoundary
{
    MKPolygon *polygon = [MKPolygon polygonWithCoordinates:self.park.boundry count:self.park.boundaryPointsCount];
